...
<head>
	...
	<!-- <link href="<?php echo base_url(); ?>assets/css/style1.css" rel="stylesheet" media="all"> -->
			...
			<nav class="navbar-mobile">
				<div class="container-fluid">
					<ul class="navbar-mobile__list list-unstyled">
						<li>
							<a href="<?php echo base_url(); ?>user/index/<?php echo $udata['user_id'] ?>">
						...
						<li class="has-sub">	
							<a class="js-arrow" href="<?php echo base_url(); ?>examinations/viewExams/<?php echo $udata['user_username'] ?>">
							<i class="fas fa-book-reader"></i>
								Assessments
							</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>examinations/examHistory/<?php echo $udata['user_username'] ?>">
				...
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li  class="active has-sub">
							<a href="<?php echo base_url(); ?>examinations/viewExams/<?php echo $udata['user_username'] ?>">
							<i class="fas fa-book-reader"></i>
							Assessments
							</a>
						</li>
