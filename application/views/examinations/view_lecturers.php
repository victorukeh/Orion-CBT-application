...
<br><br> -->
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			...
			<h2 class="text-info">All Lecturers</h2>
			<br>
			<div class="col-lg-12">
						...
						if (isset($lecturers)) {
							foreach ($lecturers as $lecturer) {   ?>
								<tr>
									...
									<td></td>
									<!-- <td><?php echo $lecturer['user_department'] ?></td> -->
									<td>
										<!-- <a href="<?= site_url('user/view_user/') . $lecturer['user_id']; ?>" class="btn btn-primary btn-sm">View</a> -->
										<a href="<?php echo base_url(); ?>user/edit_user/<?php echo $udata['user_id'] ?>/<?php echo $lecturer['user_id'] ?>" 
										class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>Edit</a>
										<a href="<?php echo base_url(); ?>user/delete_user/<?php echo $udata['user_id'] ?>/<?php echo $lecturer['user_id'] ?>"
										 onclick="return confirm('Are you sure?')" ; class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Delete</a>
									</td>
